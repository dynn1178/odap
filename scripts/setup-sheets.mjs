...
const HEADERS = {
  ...
  한줄남기기: ["작성일시", "회원ID", "과목코드", "이름", "내용", "진도율", "마스터율"],
};
...
const SAMPLE_QUESTIONS = [
  ...
  ["S-0003", "다음 중 보기 개수가 달라도 되는 것은?", "오답 보기", "정답", "문제 지문", "문제ID", "", "", "", "오답 보기 수는 문제마다 달라도 됩니다.", "Y"],
  ["S-0004", "다음 중 물을 이루는 원소를 모두 고르세요.", "산소;수소", "질소", "탄소", "헬륨", "", "", "", "정답 칸에 ; 로 나열하면 나열한 보기를 모두 골라야 정답인 문제가 됩니다.", "Y", "", "숨 쉴 때 필요한 *산*소와, 이름에 *수*가 들어가는 것."],
];
